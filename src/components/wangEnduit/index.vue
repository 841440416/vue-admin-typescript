  ...
  export default {  
    ...
    methods: {  
      ...
      seteditor() {
        ...
        this.editor.customConfig.uploadImgServer = this.requrlfwb// 填写配置服务器端地址  
        this.editor.customConfig.uploadImgHeaders = this.headers// 自定义 header  
        ...
        this.editor.customConfig.uploadImgHooks = {  
          ...
          customInsert: (insertImg, result, editor) => {  
            ...
            if (result.result.error == 0) {  
                insertImg(result.result.ip+ result.result.data[0])  
            } else {  
