...
<template>
    <div class="main" :class="{'main-hide-text': shrink}">
        <div class="back sidebar-menu-con" :style="{width: shrink?'80px':'256px', overflow: shrink ? 'visible' : 'auto'}">
            <shrinkable-menu 
                :shrink="shrink"
                ...
                :menu-list="menuList">
                <div slot="top" class="logo-con back" style="position: relative;top: -5px;">
                  <div v-if="shrink==true" style="margin-left:0px;">
                  
                   <img src="../assets/logo2.png">
                  </div>

                  <img src="../assets/logo1.png" style="height: 80px;margin-left:10px;">
                   <!--
                     <a v-if="shrink==false" style="margin-left:10px;">
                    <h1 >{{L('AppName')}}</h1>
                  </a>
                   -->
                </div>
...
<script lang="ts">
    ...
    @Component({
      components:{shrinkableMenu,tagsPageOpened,breadcrumbNav,fullScreen,notice,copyfooter}
    })
